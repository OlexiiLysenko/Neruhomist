...
if ( ! function_exists( 'e_commerce_footer_info' ) ) :
	...
	function e_commerce_footer_info() { ?>
		<div class="site-info">
			<?php printf( _x( 'Всі права захищено &copy; %1$s %2$s' , '1: Year, 2: Site Title with home URL', 'e-commerce' ), esc_attr( date_i18n( __( 'Y', 'e-commerce' ) ) ), '<a href="'. esc_url( home_url( '/' ) ) .'">'. esc_attr( get_bloginfo( 'name', 'display' ) ) . '</a>' ); ?>
			<span class="sep"> </span>
