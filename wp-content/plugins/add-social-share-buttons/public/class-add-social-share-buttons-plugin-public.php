                        ...
                        if ($get_services['share_button'] != '' && !empty($get_services['share_button'])) {
                            ...
                            foreach ($get_services['share_button'] as $key => $values) {
                                if ($values == 'Facebook') {
                                    ...
                                    $html .='<a href="https://twitter.com/intent/tweet?url=' . esc_url(get_permalink($post->ID)) . '&amp;count=none" class="social-twitter"><img src="' . $sharebuttonArray[$values] . '" alt="' . $values . '"></a>';
            ...
            if ($get_services['share_button'] != '' && !empty($get_services['share_button'])) {
                ...
                foreach ($get_services['share_button'] as $key => $values) {
                    if ($values == 'Facebook') {
                        ...
                        $html .='<a href="https://twitter.com/intent/tweet?url=' . $requestPageUrl . '&amp;count=none" class="social-twitter"><img src="' . $sharebuttonArray[$values] . '" alt="' . $values . '"></a>';
                    } elseif ($values == 'Whatsapp') {
