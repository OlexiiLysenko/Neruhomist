...
<div class="uwp-content-wrap">
    <div class="uwp-login">
        ...
        <div class="uwp-forgotpsw" style="float: left;"><a href="<?php echo uwp_get_page_link('forgot'); ?>"><?php echo __( 'Forgot password? ', 'userswp' ); ?></a> <a rel="nofollow" href="<?php echo uwp_get_page_link('register'); ?>">  <?php echo __( ' Create Account', 'userswp' ); ?></a></div>
        <div class="clfx"></div>
        <div class="uwp-register-now"><?php //echo __( 'Not a Member?', 'userswp' ); ?></div>
    </div>
    <br>
</div>
